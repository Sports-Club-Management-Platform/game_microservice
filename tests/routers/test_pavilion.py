...
from db.database import get_db
from main import app
from models.pavilion import Pavilion  # Importando o modelo correto
...
def test_get_pavilion_by_id(mock_db):
    pavilion_data = Pavilion(id=1, name="Test Pavilion", location="Test Location", image="path/to/image.jpg")
...
# @patch("crud.pavilionRepo.create_image")
# def test_update_pavilion(mock_create_image, mock_db):
#     mock_create_image.return_value = "path/to/new_pavilion_image.jpg"
...
# def test_delete_pavilion(mock_db):
